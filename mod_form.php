...
class mod_iassign_mod_form extends moodleform_mod {
  ...
  function definition () {
    ...
    //$this->standard_groups_elements();//F
    //$this->standard_grouping_elements();//F

    $mform->addElement('header', 'group_submission_header', get_string('group_submission_header', 'iassign'));
    $mform->addElement('selectyesno', 'group_submission', get_string('group_submission', 'iassign'));
    $mform->setDefault('group_submission', 0); 
    $mform->addHelpButton('group_submission', 'helpgroup_submission', 'iassign');
