...
$string['group_submission_header']        = 'Group Submission';
$string['group_submission']               = 'Enable group submission (one submission per group)?';
$string['helpgroup_submission']           = 'If enabled, only one member of the group needs to submit the activity. The submission will count for all group members.';
$string['error_group_submission']         = 'Error: Group submission is enabled, but the activity is not set to be completed by a group. Please check the activity settings.';